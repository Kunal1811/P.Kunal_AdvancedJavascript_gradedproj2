	...
	if(searchResults.length === 0) {
		listDiv.innerHTML = `
			<div style="border: 1px solid black; border-radius: 10px; padding: 20px; margin-left: 20%; margin-right: 20%">
				<img width='80' height='80' src='no-result-found.png' alt='No such result found'/>
				<span style="text-align: center; position: absolute; top: 100px;"> No such result found</span>
			</div>
		`;
	}
